      ...
      this.apiService.post<ApiResponse>('api/createoffload',this.siloLoad)
        .subscribe(result => {
          ...
          if (resp.success)
          {
            ...
            console.log('post api/createoffload :' + JSON.stringify(this.siloLoad));
...
{
    //api get call
    this.apiService.get<ApiResponse>('api/getfinalizedoffloading')
      .subscribe(result => {
        var resp = result;
        if (resp.success)
        {
          this.finalizedOffLoads = resp.items;
          console.log('api/getfinalizedoffloading: ' + JSON.stringify(this.finalizedOffLoads));
        }
        else{
          this.error = resp.message;
          console.log('api/getfinalizedoffloading: ' + this.error);
        }
      })
}
